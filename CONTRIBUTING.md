...
Thank you for your interest in contributing to {Package-Title}!
...
1. Clone the repository into your CakePHP application's `plugins` directory:
   ...
   git clone https://github.com/{git-user}/{git-repo}.git
   ```
...
1. Add the autoloader to your application's `composer.json`:
   ...
   "autoload": {
       "psr-4": {
           "{Package-Title}\\": "plugins/{git-repo}/src/"
       }
   }
   ```
...
- Use the [Issue Tracker](https://github.com/{git-user}/{git-repo}/issues)
